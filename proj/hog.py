...
def fuzzy_points(score):
    ...
    while (fuzzy!=1 and fuzzy>10):
        score=(fuzzy//10%10)*2+score
        return score
    return score
...
def play(strategy0, strategy1, update,
    ...
    #         print("DEBUG strategy:", strategy0(score0,score1))
    #         print("DEBUG score0:", score0)
    #     else:
    #         score0=fuzzy_update(strategy0, score1, score0, dice)

    #     if(who==1 and update==simple_update):
    #         score1=simple_update(strategy1(score1,score0), score1, score0, dice)
    #     else:
    #         score1=fuzzy_update(strategy1(score1,score0), score1, score0, dice)
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    #make_averaged(original_function, total_samples=1000)
    #averaged_dice = make_averaged(roll_dice, 40)
    #averaged_dice(1, dice) (*args)
...
def fuzzy_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    #fuzzy_update(num_rolls, player_score, opponent_score, dice=six_sided)
    new_score=fuzzy_update(0, score, opponent_score)
    print("DEBUG", new_score)
